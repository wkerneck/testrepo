...
```
<br>
<strong>Step 8:</strong> If we take the standard deviation of the orginal 'z' samples size and divide it by the square root of the 'f' sample size off 100 the results should be the same as the orginal standard deviation of the 'f' sample. By comparing the two demostrates the central limit theorem.
<br>
```{r}
sd(f)/sqrt(100)
```
